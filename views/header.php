...
<!-- Mirrored from freshcart.codescandy.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Nov 2023 14:18:02 GMT -->
                    ...
                    <div class="col-lg-2 col-xxl-2 text-end col-md-6 col-7">
                        <div class="list-inline">
                            <div class="list-inline-item me-5 ">
                                <a class="text-muted position-relative" data-bs-target="#offcanvasRight" href="?act=cart" role="button" aria-controls="offcanvasRight">
                            ...
                            <ul class="navbar-nav align-items-center">
                                ...
                                <li class="nav-item dropdown w-100 w-lg-auto dropdown-flyout">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="navbarDropdownDocs">
                                        <a class="dropdown-item align-items-start" href="#!">
                                            <div>
