                ...
                <div class="col-lg-8 col-md-7">
                    <div class="py-3">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-6 col-md-6 col-lg-7">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-3">
                                                <!-- title -->
                                                <a href="?act=product_detail" class="text-inherit">
                                                    <h6 class="mb-0">Product 1</h6>
                                                </a>
                                                <!-- text -->
                                                <div class="mt-4 small lh-1">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="?act=categories" class="btn btn-primary">Continue Shopping</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card mb-2">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        ...
                                        <span class="fw-bold text-danger">$67.00</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="d-grid mb-1 mt-4">
                                <!-- btn -->
                                <a href="?act=checkout" class="btn btn-primary btn-lg d-flex justify-content-between align-items-center" type="submit">
                                    Go to Checkout
