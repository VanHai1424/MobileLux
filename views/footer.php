         ...
         <div class="row g-4 py-4">
                 ...
                 <div class="row">
                     <div class="col-6">
                         ...
                         <ul class="nav flex-column">
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Apple</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Samsung</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Xiaomi</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Vivo</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Oppo</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Huawei</a></li>
                     ...
                     <div class="col-6">
                         <!-- list -->
                         <ul class="nav flex-column">
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Realme</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Lenovo</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Nokia</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Asus</a></li>
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">Vsmart</a></li>
             ...
             <div class="col-12 col-md-12 col-lg-8">
                 <div class="row g-4">
                     ...
                     <div class="col-6 col-sm-6 col-md-3">
                         <h6 class="mb-4"> MobileLux programs</h6>
                         <ul class="nav flex-column">
                             <!-- list -->
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">MobileLux programs</a></li>
                             ...
                             <li class="nav-item mb-2"><a href="#!" class="nav-link">MobileLux Ads</a></li>
             ...
             <div class="row align-items-center">
                 ...
                 <div class="col-lg-7 mt-4 mt-md-0">
                     <ul class="list-inline mb-0 text-lg-end text-center">
                         <li class="list-inline-item mb-2 mb-md-0 text-dark">Get deliveries with MobileLux</li>
