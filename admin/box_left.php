    ...
    <div class="navbar-vertical">
        ...
        <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
            <ul class="navbar-nav flex-column" id="sideNavbar">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="?act=list_product">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="?act=list_category">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                <li class="nav-item">
                    <a class="nav-link " href="?act=list_order">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="?act=list_user">
                        <div class="d-flex align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="?act=list_review">
                        <div class="d-flex align-items-center">
