        ...
        group.addEventListener("click", function (event) {
            if (event.target.classList.contains("button-plus")) {
                ...
                var target = event.target,
                    ...
                    input = target.closest("div").querySelector('input[name="' + fieldName + '"]'),
                    inputMax = parseInt(input.getAttribute('max')),
                    currentValue = parseInt(input.value, 10) || 0;
                    // Kiểm tra giá trị hiện tại trước khi tăng
                ...
                var target = event.target,
                    fieldName = target.getAttribute("data-field"),
                    input = target.closest("div").querySelector('input[name="' + fieldName + '"]'),
                    inputMin = parseInt(input.getAttribute('min')),
                    currentValue = parseInt(input.value, 10) || 0;
                    // Kiểm tra giá trị hiện tại trước khi giảm
